...
function startwatch() {
	watch([`app/styles/sass/**/*`, 'app/components/**/*.sass', 'app/libs/**/*.sass'], { usePolling: true }, styles)
...
exports.assets  = series(html, scripts, styles, images)
exports.build   = series(cleandist, html, scripts, styles, images, buildcopy)
