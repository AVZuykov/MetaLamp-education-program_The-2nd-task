...
__webpack_require__(7); // // Import vendor jQuery plugin example (not module)
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  dropdowns = dropdowns.map(function (dropdown) {
    return new _libs_form_elements_dropdown_js__WEBPACK_IMPORTED_MODULE_3__["default"](dropdown).init();
  }); // like button init
...
var Dropdown = /*#__PURE__*/function () {
  function Dropdown(elem) {
    ...
    this.isShowTotal = this.elem.querySelector('.showTotal'); // states
  ...
  _createClass(Dropdown, [{
    key: "init",
    value: function init() {
      this.handlerEventListeners(this.elem); // set initialized to `true`
    ...
    value: function handlerEventListeners(elem) {
      ...
      var acceptBtn = elem.querySelector('.dropdown-select__accept');
      var clearBtn = elem.querySelector('.dropdown-select__clear');
      this.options.forEach(function (option, idx) {
        var counterElements = option.querySelector('.dropdown-select__counter').children;
    ...
    value: function toggleDropdown() {
      ...
      } else this.dropdownField.classList.remove('input-wrapper__field_dropdown-active');
    ...
    value: function _default() {
      ...
      this.options.forEach(function (option, idx) {
        var total = option.querySelector('.dropdown-select__total');
