...
/* harmony import */ var inputmask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var inputmask__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(inputmask__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var ion_rangeslider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
...
/* harmony import */ var _libs_dropdown_dropdown__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
/* harmony import */ var _libs_like_like_button__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6);
/* harmony import */ var _libs_rate_rate_button__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7);
...
__webpack_require__(8); // // Import vendor jQuery plugin example (not module)
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  dropdowns = dropdowns.map(function (dropdown) {
    return new _libs_dropdown_dropdown__WEBPACK_IMPORTED_MODULE_3__["Dropdown"](dropdown, {
  ...
  var likeButtons = Array.from(document.querySelectorAll('.like-button'));
  likeButtons = likeButtons.map(function (likeButton) {
    return new _libs_like_like_button__WEBPACK_IMPORTED_MODULE_4__["LikeButton"](likeButton, {
      count: 22
    });
  }); //  rate button init

  var rateButtons = Array.from(document.querySelectorAll('.rate-button'));
  rateButtons = rateButtons.map(function (rateButton, idx) {
    return new _libs_rate_rate_button__WEBPACK_IMPORTED_MODULE_5__["RateButton"](rateButton, {
      rate: 3,
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.range-slider').each(function () {
    var slider = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('input');
    var from = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('.range-slider__from');
    var to = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('.range-slider__to');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.pagination').pagination({
  ...
  var inputDate = document.querySelectorAll('input[name="maskedDate"]');
  var inputEmail = document.querySelectorAll('input[name="maskedEmail"]');
  inputDate.forEach(function (el) {
    el.value = "".concat(currentDay < 10 ? '0' + currentDay : currentDay, ".").concat(currentMonth < 10 ? '0' + currentMonth : currentMonth, ".").concat(currentYear);
    inputmask__WEBPACK_IMPORTED_MODULE_1___default()({
      alias: 'datetime',
      inputFormat: 'dd.mm.yyyy',
      min: "".concat(currentDay < 10 ? '0' + currentDay : currentDay, ".").concat(currentMonth < 10 ? '0' + currentMonth : currentMonth, ".").concat(currentYear),
      max: "31.12.".concat(currentYear + 1),
      placeholder: '_',
      prefillYear: false
    }).mask(el);
  });
...
; (function (factory) {
	if ((typeof jQuery === 'undefined' || !jQuery) && "function" === "function" && __webpack_require__(4)) {
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (jQuery) {
			return factory(jQuery, document, window, navigator);
		}).apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
	} else if ((typeof jQuery === 'undefined' || !jQuery) && typeof exports === "object") {
		factory(__webpack_require__(1), document, window, navigator);
	} else {
...
function getTemplate(items, placeholder) {
  var dropdownItems = items.map(function (item, idx) {
    var _item$min, _item$max;

    var min = (_item$min = item.min) !== null && _item$min !== void 0 ? _item$min : 0;
    var max = (_item$max = item.max) !== null && _item$max !== void 0 ? _item$max : 15;
    var isActiveButton = +item.value === +min ? 'disable' : '';
    return "\n    <li class=\"dropdown__option\" \n      data-type=\"option\" \n      data-id=\"".concat(idx, "\" \n      data-max=\"").concat(max, "\" \n      data-min=\"").concat(min, "\">\n      <span class=\"dropdown__option-title\">").concat(item.title, "</span>\n      <div class=\"dropdown__option-counter\">\n        <button class=\"dropdown__counter-minus-button ").concat(isActiveButton, "\" type=\"button\" data-type=\"minusBtn\">-</button>\n        <b class=\"dropdown__counter-total\" data-type=\"counter\"> ").concat(item.value, "</b>\n        <button class=\"dropdown__counter-plus-button\" type=\"button\" data-type=\"plusBtn\">+</button>\n      </div>\n    </li>\n  ");
  });
  return "\n    <div class=\"dropdown__field\" data-type=\"field\">".concat(placeholder !== null && placeholder !== void 0 ? placeholder : 'Укажите кол-во', "</div>\n    <ul class=\"dropdown__select\">\n      ").concat(dropdownItems.join(''), "\n      <li class=\"dropdown__controls-buttons\"> \n        <button class=\"dropdown__clear-button\" disabled type=\"button\">\u041E\u0447\u0438\u0441\u0442\u0438\u0442\u044C</button>\n        <button class=\"dropdown__accept-button\" disabled type=\"button\">\u041F\u0440\u0438\u043C\u0435\u043D\u0438\u0442\u044C</button>\n      </li>\n    </ul>\n  ");
}
...
var Dropdown = /*#__PURE__*/function () {
  ...
  _createClass(Dropdown, [{
    key: "clickHandler",
    value: // Обработчик клика по полю или вне поля 
    ...
    key: "counterHandler",
    value: function counterHandler(event) {
      var type = event.target.dataset.type;
      var option = event.target.closest('[data-type="option"]');
      var iSdisabled = event.target.classList.contains('disable');

      if (option && !iSdisabled) {
        var id = option.dataset.id;
        var count = this.state.draft[id].value;
    ...
    key: "renderCount",
    value: function renderCount(option, count) {
      var minusBtn = option.querySelector('[data-type="minusBtn"]');
      var plusBtn = option.querySelector('[data-type="plusBtn"]');
      var maxValue = +option.dataset.max;
      var minValue = +option.dataset.min;
      count === maxValue ? plusBtn.classList.add('disable') : plusBtn.classList.remove('disable');
      count === minValue ? minusBtn.classList.add('disable') : minusBtn.classList.remove('disable');
      option.querySelector('[data-type="counter"]').innerText = count;
    }
  }, {
    key: "renderControlsButtons",
    value: function renderControlsButtons() {
    ...
    value: function renderField() {
      var text = '';
      this.state.draft.forEach(function (el) {
        var _declOfNum;

        text = "".concat(text).concat(!text ? '' : ',', " ").concat(el.value, " ").concat((_declOfNum = declOfNum(el.value, el.titleForms)) !== null && _declOfNum !== void 0 ? _declOfNum : el.title);
      });
    ...
    value: function saveAndClose() {
      ...
      var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.state.current;

      if (!this.isSame || state === this.state["default"]) {
        this.state.current = state.map(function (a) {
          return _objectSpread({}, a);
        });
        this.state.draft = state.map(function (a) {
          return _objectSpread({}, a);
        });
        this.selectOptions.forEach(function (option, idx) {
          var count = state[idx].value;

          _this.renderCount(option, count);
        });
        this.renderField();
      }
    ...
    get: function get() {
      ...
      return this.state["default"].every(function (defItem, idx) {
        return defItem.value === _this2.state.current[idx].value;
      });
    }
  }, {
    key: "isSame",
    get: function get() {
      ...
      return this.state.current.every(function (curItem, idx) {
        return curItem.value === _this3.state.draft[idx].value;
      });
    }
  }, {
    key: "isOpen",
...
function _setup2() {
  this.state = {
    ...
    current: this.options.items.map(function (a) {
      return _objectSpread({}, a);
    }),
    draft: this.options.items.map(function (a) {
      return _objectSpread({}, a);
    })
  };
...
function getTemplate(options) {
  return "\n  <div class=\"like-button\">\n    <span class=\"like-button__counter\">".concat(options.count, "</span>\n  </div>\n  ");
}
...
var LikeButton = /*#__PURE__*/function () {
  function LikeButton(selector, options) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RateButton", function() { return RateButton; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function getTemplate(options) {
  ...
  for (var index = 0; index < 5; index++) {
    star += "<div \n      class=\"rate-button__star ".concat(index + 1 <= rate ? 'active' : '', "\" \n      data-id=").concat(index, "\n      ></div>\n    ");
  }
...
var RateButton = /*#__PURE__*/function () {
  function RateButton(selector, options) {
  ...
  _createClass(RateButton, [{
    ...
    key: "renderStars",
    value: function renderStars(id) {
      this.stars.forEach(function (star) {
        return star.classList.remove('active');
      });
      this.stars.filter(function (_, idx) {
        return idx <= id;
      }).forEach(function (star) {
        return star.classList.add('active');
      });
    }
  }]);
