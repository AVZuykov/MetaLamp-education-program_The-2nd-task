...
var Dropdown = /*#__PURE__*/function () {
  function Dropdown(options) {
    ...
    this.dropdownActiveClassField = options.field.substring(1) + '_active'; // other settings 
  ...
  _createClass(Dropdown, [{
    ...
    value: function handlerEventListeners(elem) {
      ...
      document.addEventListener('click', function (event) {
        var ddElem = event.target.closest('.dropdown');
...
function defaultState(options) {
  ...
  options.forEach(function (option) {
    var title = option.querySelector('.dropdown__option-title').innerText;
    var total = option.querySelector('.dropdown__counter-total').innerText;
    state.push({
      title: title,
      total: total
    });
