...
/* harmony import */ var _libs_dropdown_dropdown_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
/* harmony import */ var _libs_form_elements_like_button_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6);
/* harmony import */ var _libs_form_elements_rate_button_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(7);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  dropdowns = dropdowns.map(function (dropdown) {
    return new _libs_dropdown_dropdown_js__WEBPACK_IMPORTED_MODULE_3__["Dropdown"](dropdown, {
  ...
  window.dropdown = dropdowns[0]; // like button init

  var likeButtons = Array.from(document.querySelectorAll('.like-button'));
  likeButtons = likeButtons.map(function (likeButton) {
    return new _libs_form_elements_like_button_js__WEBPACK_IMPORTED_MODULE_4__["default"]({
      elem: likeButton,
  ...
  rateButtons = rateButtons.map(function (rateButton) {
    return new _libs_form_elements_rate_button_js__WEBPACK_IMPORTED_MODULE_5__["default"]({
      elem: rateButton,
...
var LikeButton = /*#__PURE__*/function () {
  ...
  _createClass(LikeButton, [{
    ...
    key: "handlerEventListeners",
    value: function handlerEventListeners() {
      var _this = this;
    ...
    value: function handlerEventListeners() {
      ...
      this.stars.forEach(function (star, idx) {
        star.addEventListener('click', function (event) {
          _this.changeRate(idx);
        });
      });
    }
  }, {
    key: "changeRate",
    value: function changeRate(index) {
      var _this2 = this;

      this.rate = index + 1;
      this.stars.forEach(function (star) {
        return star.classList.remove(_this2.activeStar);
      });
      this.stars.filter(function (star, idx) {
        return idx <= index;
      }).forEach(function (star) {
        return star.classList.add(_this2.activeStar);
      });
    }
  }]);
