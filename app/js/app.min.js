...
__webpack_require__(6); // // Import vendor jQuery plugin example (not module)
...
document.addEventListener('DOMContentLoaded', function () {
  var dropdowns = document.querySelectorAll('.input-wrapper_dropdown');
  var ddArr = [];
  dropdowns.forEach(function (dropdown) {
    var dd = new _libs_form_elements_dropdown_js__WEBPACK_IMPORTED_MODULE_3__["default"](dropdown);
    dd.init();
    ddArr.push(dd);
  }); // Range slider
  ...
  _createClass(Dropdown, [{
    ...
    value: function handlerEventListeners(elem) {
      ...
      clearBtn.addEventListener('click', function (event) {
        _this.draftState = [];
        _this.state = _this.defaultState.map(function (a) {
          return _objectSpread({}, a);
        });
